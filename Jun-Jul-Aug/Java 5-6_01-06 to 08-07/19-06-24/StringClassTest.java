public class StringClassTest{
    public static void main(String[] args) {
        ...
        // to check whether string starts with some character or not
        ...
        System.out.println("Aasritha is studying in datapro".indexOf("datapro"));

        // to extract something from a big string
        System.out.println("Aasritha is studying in datapro".substring(24, 28));
    }
}